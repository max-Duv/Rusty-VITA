...
The selected concept is treated as a structural design target rather than a source of dummy content. v0.4 implements its visual grammar while binding every field to actual runtime state.
...
Where the concept showed a plausible but invented value, v0.4 prefers correctness:
