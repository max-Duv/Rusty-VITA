...
pub struct StreamMetrics {
    ...
    rate_window: VecDeque<(Instant, usize, usize)>,
}

impl StreamMetrics {
    pub fn new(fs: f64, fmt: SampleFormat, iq: bool) -> Self {
        Self { fs, fmt, iq, t0: Instant::now(), packets: 0, bytes: 0, samples: 0, seq_gaps: 0, reorders: 0, ts_drops: 0, glitches: 0, parse_errors: 0, sid: None, class_id: None, last_seq: None, last_ts: None, last_packet_bytes: 0, last_payload_bytes: 0, _ts_deltas: VecDeque::with_capacity(256), rate_window: VecDeque::with_capacity(2048) }
    }
    ...
    pub fn snapshot(&self) -> MetricsSnapshot {
        ...
        for (t, samples, bytes) in &self.rate_window {
